...
/***/ function(module, exports, __webpack_require__) {
	...
	var _task = __webpack_require__(59);
	
	var _task2 = _interopRequireDefault(_task);
	
	var _category = __webpack_require__(62);
	...
	_vue2.default.http.interceptors.push({
	  request: function request(_request) {
	    _vue2.default.http.headers.common['x-access-token'] = window.localStorage.token;
	    return _request;
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tasks = __webpack_require__(46);
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    editList: function editList(e, list) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskItem = __webpack_require__(65);
	
	var _taskItem2 = _interopRequireDefault(_taskItem);
	
	var _taskInputer = __webpack_require__(69);
	...
	exports.default = {
	  ...
	  events: {
	    'create task': function createTask(task) {
	      ...
	      this.$http.post('tasks', task).then(function (res) {
	        _this2.tasklist.unshift(res.data);
	        setTimeout(function () {
	    ...
	    'edit task': function editTask(task) {
	      var vm = this;
	      vm.$http.put('tasks/' + task.id, task).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uploadBabel = __webpack_require__(75);
	
	var _uploadBabel2 = _interopRequireDefault(_uploadBabel);
	
	var _toolBabel = __webpack_require__(76);
	...
	exports.default = {
	  ...
	  watch: {
	    'newTask.title': function newTaskTitle(val, oldval) {
	      localStorage.newTask = (0, _stringify2.default)(this.newTask);
	    },
	    'newTask.attachments': function newTaskAttachments(val, oldval) {
	      localStorage.newTask = (0, _stringify2.default)(this.newTask);
	    }
	  },
	  ready: function ready() {
	  ...
	  methods: {
	    ...
	    // 粘贴复制
	    uploadByPaste: function uploadByPaste(e) {
	      var _this = this;
